...
class AddDeviseToUsers < ActiveRecord::Migration[8.0]
  def change
    # use change_table with bulk for speed
    change_table :users, bulk: true do |t|
      ...
      # Trackable (optional) - uncomment if you want these
    ...
    # add_index :users, :unlock_token,         unique: true unless index_exists?(:users, :unlock_token, unique: true)
  end
